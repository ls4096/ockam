...
ockam_vault_extern_error_t ockam_vault_aead_aes_gcm_decrypt(ockam_vault_t       vault,
                                                            ...
                                                            size_t*              plaintext_length);
/**
 * @brief  Return persistence id of given secret.
 * @param   vault[in]               Vault object to use.
 * @param   key[in]                 Ockam secret key to use.
 * @param   persistence_id[out]     Persistence id output string buffer.
 * @param   persistence_id_size[in] Buffer size.
 * @return  error.
 */
ockam_vault_extern_error_t ockam_vault_get_persistence_id(ockam_vault_t       vault,
                                                          ockam_vault_secret_t key,
                                                          char*                persistence_id,
 ...
 * @param   vault[in]           Vault object to use.
 * @param   key[out]            Resulting secret.
 * @param   persistence_id[out] String with persistence id.
 * @return  error.
 */
ockam_vault_extern_error_t ockam_vault_get_persistent_secret(ockam_vault_t         vault,
                                                             ockam_vault_secret_t* key,
